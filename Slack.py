...
slack_token = 'xoxp-598678183767-598678184535-1161644462661-440b8f9f94b5c2f3d75fe01419ade10f'
...
def processReactionAdded(msg_dict):
  ...
  if emoji_name=='runner' or emoji_name=='running':
    ...
    #else:
      #log(W, "user covering emoji " + str(emoji_name) + ' added by ' + str(username) + ', but message with timestamp ' + str(timestamp) + " not in found :(")
